...
\fancyhead[C]{Running title $\bullet$ Dezembro 2014 $\bullet$ } % Custom header text
...
\noindent Fazer uma geral do artigo. % Dummy abstract text
...
Contextualização (falar que tem muitos dados)
Motivação (Motivação particular de você se interessar)
